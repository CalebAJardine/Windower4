function user_setup()
	...
	state.Weapons:options('None', 'Montante','Apocalypse')
...
function init_gear_sets()
    ...
    sets.engaged.SomeAcc = {ammo="Knobkierrie",
    head="Sakpata's Helm",
    body="Sakpata's Plate",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
	...
	sets.engaged.Acc = {ammo="Knobkierrie",
    head="Sakpata's Helm",
    body="Sakpata's Plate",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
    ...
    sets.engaged.FullAcc = {ammo="Knobkierrie",
    head="Sakpata's Helm",
    body="Sakpata's Plate",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
    ...
    sets.engaged.Fodder = {ammo="Knobkierrie",
    head="Sakpata's Helm",
    body="Sakpata's Plate",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
